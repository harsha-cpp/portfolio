  ...
  const experiences = [
    {
      ...
      location: "Remote",
      achievements: [
        "Designed the base UI/UX for the company website, ensuring a responsive, accessible, and visually engaging user experience",
        "Created the base UI framework of 15+ pages for the mobile app, focusing on intuitive navigation and user flows for swapping station operations",
        "Conducted user research to understand the needs of EV users and swapping station operations",
        "Collaborated closely with the engineering team to implement UI components efficiently, maintaining design consistency across platforms",
        "Supported brand identity development by aligning web and app visuals with startup goals",
      ],
    },
  ]
